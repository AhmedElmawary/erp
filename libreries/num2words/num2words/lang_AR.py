...
class Num2Word_AR(object):
    ...
    def __init__(self):
        ...
        self.arabicAppendedTwos = [
            "مائتان", "ألفان", "اثنين مليون", " اثنين مليار", " اثنين تريليون", " اثنين كوادريليون",
            "اثنين كوينتليون", " اثنين سكستيليون "
        ]

        self.arabicTwos = [
            "مائتان", "ألفان", "مليونان", "ملياران", "تريليونان",
