...
function make_prices_dynamic() {
    ...
    add_new_item = document.getElementsByClassName('djn-add-item').item(0).lastElementChild,
    total_cost = document.getElementsByClassName(field_cost).item(0).lastElementChild;
